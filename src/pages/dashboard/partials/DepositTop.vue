...
<script>
import {DEPOSIT_TABLE_TH} from "@/pages/dashboard/dashboardData";

export default {
  name: "DepositTop",
  data() {
    return {
      dates: DEPOSIT_TABLE_TH,
    }
  },
}
</script>
